# dnsmasq 2.91 - Performance & Stability Patches

**Version:** 2.91 with Phase 1 + Phase 2 optimizations
**Date:** 2025-11-16
...
Dieser Ordner enthält die **vollständig gepatchten Dateien** von dnsmasq 2.91 mit allen Performance- und Stabilitäts-Fixes.

### **Gepatchte Dateien:**

**Source Code:**
- `src/db.c` - Hauptdatei mit allen Fixes (Phase 1 + Phase 2)
- `src/dnsmasq.h` - Header mit Strukturdefinitionen
- `src/config.h` - Build-Konfiguration
- `src/dnsmasq` - **Kompilierte Binary (463 KB)**
...
### **Option 1: Binary direkt verwenden**
```bash
# Binary kopieren
...
```bash
# In das dnsmasq-2.91 Verzeichnis wechseln
cd ../dnsmasq-2.91

# db.c mit Patches überschreiben
cp ../dnsmasq2.91-PATCH/src/db.c src/
...
**Date:** 2025-11-16
**Version:** dnsmasq 2.91 + Phase 1 + Phase 2
